...
ActiveRecord::Schema.define(version: 20141125033233) do
  ...
  add_index "histories", ["publication_id"], name: "index_histories_on_publication_id", using: :btree
  ...
  add_index "publications_and_histories", ["history_id"], name: "index_publications_and_histories_on_history_id", using: :btree
  add_index "publications_and_histories", ["llink_id"], name: "index_publications_and_histories_on_llink_id", using: :btree
  add_index "publications_and_histories", ["publication_id"], name: "index_publications_and_histories_on_publication_id", using: :btree
